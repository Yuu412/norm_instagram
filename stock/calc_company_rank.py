...
INPUT_COLS = ['証券コード', '企業名', '安定性_1', '安定性_2', '安定性_3', '成長性_1', '成長性_2', '成長性_3', '収益性_1', '収益性_2', '収益性_3', '安定性_順位', '成長性_順位', '収益性_順位']
OUTPUT_COLS = ['証券コード', '企業名', '安定性_1', '安定性_2', '安定性_3', '成長性_1', '成長性_2', '成長性_3', '収益性_1', '収益性_2', '収益性_3', '安定性_1_ランク', '安定性_順位', '成長性_順位', '収益性_順位', '安定性_1_ランク', '安定性_2_ランク', '安定性_3_ランク', '成長性_1_ランク', '成長性_2_ランク', '成長性_3_ランク', '収益性_1_ランク', '収益性_2_ランク', '収益性_3_ランク']
COLS = ['安定性', '成長性', '収益性']
...
for industry_csv in indestry_csv_list:
    ...
    if(os.path.isfile(OUTPUT_PAHT + industry + '/company_score_rank.csv')):
        os.remove(OUTPUT_PAHT + industry + '/company_score_rank.csv')
        continue
    ...
    loop_cols = INPUT_COLS[2:12]
    for col_name in loop_cols:
        df_score = df_score.sort_values(col_name)
        df_score[col_name + '_ランク'] = rank_list

    df_score.to_csv(OUTPUT_PAHT + industry + '/company_score.csv', header=OUTPUT_COLS, encoding="utf-8", index=False)